    ...
    return function(r) {
        ...
        var k = {
            ...
            M = function(e) {
                ...
                for (var r in t.className = S(this.classes), this.style) this.style.hasOwnProperty(r) && (t.style[r] = this.style[r]);
            ...
            B = function(e) {
                var t = "<" + e;
                this.classes.length && (t += ' class="' + Y.escape(S(this.classes)) + '"');
                var r = "";
                for (var n in this.style) this.style.hasOwnProperty(n) && (r += Y.hyphenate(n) + ":" + this.style[n] + ";");
                for (var i in r && (t += ' style="' + Y.escape(r) + '"'), this.attributes) this.attributes.hasOwnProperty(i) && (t += " " + i + '="' + Y.escape(this.attributes[i]) + '"');
                t += ">";
            ...
            C = function() {
                function e(e, t, r, n) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, z.call(this, e, r, n), this.children = t || []
                }
                var t = e.prototype;
            ...
            N = function() {
                function e(e, t, r, n) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, z.call(this, t, n), this.children = r || [], this.setAttribute("href", e)
                }
                var t = e.prototype;
                return t.setAttribute = function(e, t) {
                    this.attributes[e] = t
            ...
            O = function() {
                ...
                return t.hasClass = function(e) {
                    ...
                    var e = document.createTextNode(this.text),
                        t = null;
                    for (var r in 0 < this.italic && ((t = document.createElement("span")).style.marginRight = this.italic + "em"), 0 < this.classes.length && ((t = t || document.createElement("span")).className = S(this.classes)), this.style) this.style.hasOwnProperty(r) && ((t = t || document.createElement("span")).style[r] = this.style[r]);
                    return t ? (t.appendChild(e), t) : e
                }, t.toMarkup = function() {
                    var e = !1,
                        t = "<span";
                    this.classes.length && (e = !0, t += ' class="', t += Y.escape(S(this.classes)), t += '"');
                    var r = "";
                    for (var n in 0 < this.italic && (r += "margin-right:" + this.italic + "em;"), this.style) this.style.hasOwnProperty(n) && (r += Y.hyphenate(n) + ":" + this.style[n] + ";");
        ...
        var Ie = Oe,
            ...
            De = ["\\imath", "\u0131", "\\jmath", "\u0237", "\\pounds", "\\mathsterling", "\\textsterling", "\xa3"],
            Pe = function(e, t, r) {
            ...
            Ve = function(e, t) {
                if (S(e.classes) !== S(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize) return !1;
            ...
            $e = {
                ...
                mathsym: function(e, t, r, n) {
                    return void 0 === n && (n = []), r && r.font && "boldsymbol" === r.font && Pe(e, "Main-Bold", t).metrics ? Fe(e, "Main-Bold", t, r, n.concat(["mathbf"])) : "\\" === e || "main" === W[t][e].font ? Fe(e, "Main-Regular", t, r, n) : Fe(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
                },
                makeSpan: Ge,
                makeSvgSpan: Xe,
                ...
                makeOrd: function(e, t, r) {
                    ...
                    if (l) {
                        ...
                        if ("boldsymbol" === l || "mathnormal" === l) {
                            var d = "boldsymbol" === l ? Pe(a, "Math-BoldItalic", i).metrics ? {
                        ...
                        } else p = Y.contains(De, a) ? (u = "Main-Italic", ["mathit"]) : s ? (u = We[l].fontName, [l]) : (u = _e(l, t.fontWeight, t.fontShape), [l, t.fontWeight, t.fontShape]);
                        if (Pe(a, u, i).metrics) return Fe(a, u, i, t, o.concat(p));
                        if (me.hasOwnProperty(a) && "Typewriter" === u.substr(0, 10)) {
                            for (var f = [], g = 0; g < a.length; g++) f.push(Fe(a[g], u, i, t, o.concat(p)));
                            return Ye(f)
                        }
                    }
                    if ("mathord" === r) {
                        var v = /[0-9]/.test((w = a).charAt(0)) || Y.contains(De, w) ? {
                            fontName: "Main-Italic",
                            fontClass: "mathit"
                        } : {
                            fontName: "Math-Italic",
                    ...
                    if ("ams" === y) {
                        ...
                        return Fe(a, b, i, t, o.concat("amsrm", t.fontWeight, t.fontShape))
                    }
                    if ("main" !== y && y) {
                        var x = _e(y, t.fontWeight, t.fontShape);
                        return Fe(a, x, i, t, o.concat(x, t.fontWeight, t.fontShape))
                    }
                    var w, k = _e("textrm", t.fontWeight, t.fontShape);
                ...
                tryCombineChars: function(e) {
                    for (var t = 0; t < e.length - 1; t++) {
                        var r = e[t],
                            n = e[t + 1];
                        r instanceof O && n instanceof O && Ve(r, n) && (r.text += n.text, r.height = Math.max(r.height, n.height), r.depth = Math.max(r.depth, n.depth), r.italic = n.italic, e.splice(t + 1, 1), t--)
                    }
                    return e
                }
            };
        ...
        function Je(e, t) {
            var r, n, i = (n = t, (r = e) && "atom" === r.type && r.family === n ? r : null);
        ...
        var mt = function(e) {
            ...
            dt = function(e, t, r, n) {
                ...
                for (var l, h, m, c, u = [n[0] ? ct([n[0]], [], t) : null].concat(i.filter(function(e) {
                        return e && "mspace" !== e.classes[0]
                    }), [n[1] ? ct([n[1]], [], t) : null]), p = 1; p < u.length - 1; p++) {
                    var d = T(u[p]),
                        f = ft(d, "left");
                    "mbin" === f.classes[0] && (m = u[p - 1], c = r, m ? Y.contains(["mbin", "mopen", "mrel", "mop", "mpunct"], gt(m, "right")) : c) && (f.classes[0] = "mord");
                    var g = ft(d, "right");
                    "mbin" === g.classes[0] && (l = u[p + 1], h = r, l ? Y.contains(["mrel", "mclose", "mpunct"], gt(l, "left")) : h) && (g.classes[0] = "mord")
                }
                for (var v = [], y = 0, b = 0; b < i.length; b++)
                    if (v.push(i[b]), "mspace" !== i[b].classes[0] && y < u.length - 1) {
                        0 === y && (v.pop(), b--);
                        var x = gt(u[y], "right"),
                            w = gt(u[y + 1], "left");
                        if (x && w && r) {
                            ...
                            if (S) {
                                ...
                                if (1 === e.length) {
                                    ...
                                    M && ("sizing" === M.type ? z = t.havingSize(M.size) : "styling" === M.type && (z = t.havingStyle(ut[M.style])))
                                }
        ...
        function wt(e, t) {
            ...
            for (var n, i = dt(e, t, !0), a = [], o = [], s = 0; s < i.length; s++)
                if (o.push(i[s]), i[s].hasClass("mbin") || i[s].hasClass("mrel") || i[s].hasClass("allowbreak")) {
                    for (var l = !1; s < i.length - 1 && i[s + 1].hasClass("mspace");) s++, o.push(i[s]), i[s].hasClass("nobreak") && (l = !0);
                    l || (a.push(xt(o, t)), o = [])
                } else i[s].hasClass("newline") && (o.pop(), 0 < o.length && (a.push(xt(o, t)), o = []), a.push(i[s]));
            0 < o.length && a.push(xt(o, t)), r && ((n = xt(dt(r, t, !0))).classes = ["tag"], a.push(n));
        ...
        var St = function() {
            ...
            Tt = function(e, t, r) {
                return !W[t][e] || !W[t][e].replace || 55349 === e.charCodeAt(0) || me.hasOwnProperty(e) && r && (r.fontFamily && "tt" === r.fontFamily.substr(4, 2) || r.font && "tt" === r.font.substr(4, 2)) || (e = W[t][e].replace), new Mt.TextNode(e)
            },
            At = function(e) {
            ...
            Bt = function(e, t) {
                ...
                var i = e.text;
                return Y.contains(["\\imath", "\\jmath"], i) ? null : (W[n][i] && W[n][i].replace && (i = W[n][i].replace), F(i, $e.fontMap[r].fontName, n) ? $e.fontMap[r].variant : null)
            },
            Ct = function(e, t) {
        ...
        var Et = function(e) {
            ...
            Ot = function(e, t, r) {
                var n = Et(r),
                    i = function(e, t, r) {
                        var n, i = Ct(e, r);
                        n = 1 === i.length && i[0] instanceof St && Y.contains(["mrow", "mtable"], i[0].type) ? i[0] : new Mt.MathNode("mrow", i);
            ...
            Dt = function(S, z) {
                var e = function() {
                        ...
                        if (Y.contains(["widehat", "widecheck", "widetilde", "utilde"], t)) {
                            var r, n, i, a = "ordgroup" === (c = S.base).type ? c.body.length : 1;
            ...
            Pt = function(e, t) {
                var r, n, i, a = Ke(e, "supsub");
                a ? (r = (n = Ze(a.base, "accent")).base, a.base = r, i = function(e) {
                    if (e instanceof C) return e;
                    throw new Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
                }(bt(a, t)), a.base = n) : r = (n = Ze(e, "accent")).base;
                ...
                var h, m = Math.min(o.height, t.fontMetrics().xHeight);
                if (n.isStretchy) h = Dt(n, t), h = $e.makeVList({
                    ...
                    var c, u;
                    u = "\\vec" === n.label ? (c = $e.staticSvg("vec", t), $e.svgData.vec[1]) : ((c = $e.makeSymbol(n.label, "Main-Regular", n.mode, t)).italic = 0, c.width), h = $e.makeSpan(["accent-body"], [c]);
            ...
            Ft = function(e, t) {
                var r = e.isStretchy ? Ht(e.label) : new Mt.MathNode("mo", [Tt(e.label, e.mode)]),
                    n = new Mt.MathNode("mover", [qt(e.base, t), r]);
                return n.setAttribute("accent", "true"), n
            },
            Vt = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(function(e) {
                return "\\" + e
            }).join("|"));
        lt({
            type: "accent",
            ...
            htmlBuilder: function(e, t) {
                ...
                a.classes.push("x-arrow-pad"), e.below && (i = t.havingStyle(n.sub()), (r = $e.wrapFragment(bt(e.below, i, t), t)).classes.push("x-arrow-pad"));
                var o, s = Dt(e, t),
                ...
                return o.children[0].children[0].children[1].classes.push("svg-align"), $e.makeSpan(["mrel", "x-arrow"], [o], t)
            },
            mathmlBuilder: function(e, t) {
                var r, n, i = Ht(e.label);
                if (e.body) {
                    var a = qt(e.body, t);
                    r = e.below ? (n = qt(e.below, t), new Mt.MathNode("munderover", [i, n, a])) : new Mt.MathNode("mover", [i, a])
                } else r = e.below ? (n = qt(e.below, t), new Mt.MathNode("munder", [i, n])) : new Mt.MathNode("mover", [i]);
                return r
            }
        }), lt({
            type: "textord",
            ...
            handler: function(e, t) {
                for (var r = e.parser, n = Ze(t[0], "ordgroup").body, i = "", a = 0; a < n.length; a++) {
        ...
        var Xt = function(e, t, r) {
            ...
            Wt = function(e, t, r, n, i, a) {
                var o, s, l, h, m = (o = e, s = t, l = i, h = n, $e.makeSymbol(o, "Size" + s + "-Regular", l, h)),
                    c = Yt($e.makeSpan(["delimsizing", "size" + t], [m], n), q.TEXT, n, a);
            ...
            Kt = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230a", "\u230b", "\\lceil", "\\rceil", "\u2308", "\u2309", "\\surd"],
            Jt = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27ee", "\u27ef", "\\lmoustache", "\\rmoustache", "\u23b0", "\u23b1"],
            Qt = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"],
            er = [0, 1.2, 1.8, 2.4, 3],
            tr = [{
                type: "small",
            ...
            or = function(e, t, r, n, i, a) {
                var o;
                "<" === e || "\\lt" === e || "\u27e8" === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && "\u27e9" !== e || (e = "\\rangle"), o = Y.contains(Qt, e) ? tr : Y.contains(Kt, e) ? nr : rr;
                var s, l, h, m, c, u, p, d, f = ar(e, t, o, n);
                return "small" === f.type ? (s = e, l = f.style, h = r, m = n, c = i, u = a, p = $e.makeSymbol(s, "Main-Regular", c, m), d = Yt(p, l, m, u), h && _t(d, m, l), d) : "large" === f.type ? Wt(e, f.size, r, n, i, a) : $t(e, t, r, n, i, a)
            },
            sr = function(e, t) {
                var r, n, i = t.havingBaseSizing(),
                    a = ar("\\surd", e * i.sizeMultiplier, nr, i),
                    o = i.sizeMultiplier,
                    s = 0,
                    l = 0,
                    h = 0;
                return n = "small" === a.type ? (e < 1 ? o = 1 : e < 1.4 && (o = .7), l = 1 / o, (r = Zt("sqrtMain", s = 1.08 / o, h = 1080, t)).style.minWidth = "0.853em", .833 / o) : "large" === a.type ? (h = 1080 * er[a.size], l = er[a.size] / o, s = (er[a.size] + .08) / o, (r = Zt("sqrtSize" + a.size, s, h, t)).style.minWidth = "1.02em", 1 / o) : (s = e + .08, l = e, h = Math.floor(1e3 * e) + 80, (r = Zt("sqrtTall", s, h, t)).style.minWidth = "0.742em", 1.056), r.height = l, r.style.height = s + "em", {
                    span: r,
                    advanceWidth: n,
            ...
            lr = function(e, t, r, n, i) {
                if ("<" === e || "\\lt" === e || "\u27e8" === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && "\u27e9" !== e || (e = "\\rangle"), Y.contains(Kt, e) || Y.contains(Qt, e)) return Wt(e, t, !1, r, n, i);
            ...
            ur = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230a", "\u230b", "\\lceil", "\\rceil", "\u2308", "\u2309", "<", ">", "\\langle", "\u27e8", "\\rangle", "\u27e9", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27ee", "\u27ef", "\\lmoustache", "\\rmoustache", "\u23b0", "\u23b1", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
        ...
        lt({
            ...
            htmlBuilder: function(e, t) {
                return "." === e.delim ? $e.makeSpan([e.mclass]) : lr(e.delim, e.size, t, e.mode, [e.mclass])
            },
            ...
            htmlBuilder: function(e, t) {
                dr(e);
                for (var r, n, i = dt(e.body, t, !0, [null, "mclose"]), a = 0, o = 0, s = !1, l = 0; l < i.length; l++) i[l].isMiddle ? s = !0 : (a = Math.max(i[l].height, a), o = Math.max(i[l].depth, o));
                if (a *= t.sizeMultiplier, o *= t.sizeMultiplier, r = "." === e.left ? yt(t, ["mopen"]) : mr(e.left, a, o, t, e.mode, ["mopen"]), i.unshift(r), s)
                    for (var h = 1; h < i.length; h++) {
                        var m = i[h].isMiddle;
                        m && (i[h] = mr(m.delim, a, o, m.options, e.mode, []))
                    }
                return n = "." === e.right ? yt(t, ["mclose"]) : mr(e.right, a, o, t, e.mode, ["mclose"]), i.push(n), $e.makeSpan(["minner"], i, t)
            },
            mathmlBuilder: function(e, t) {
                dr(e);
                var r = Ct(e.body, t);
        ...
        var fr = function(e, t) {
                var r, n, i = $e.wrapFragment(bt(e.body, t), t),
                    a = e.label.substr(1),
                    o = t.sizeMultiplier,
                    s = 0,
                    l = Y.isCharacterBox(e.body);
                if ("sout" === a)(r = $e.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / o, s = -.5 * t.fontMetrics().xHeight;
                else {
                    /cancel/.test(a) ? l || i.classes.push("cancel-pad") : i.classes.push("boxpad");
                    var h = 0;
                    h = /box/.test(a) ? "colorbox" === a ? .3 : .34 : l ? .2 : 0, r = Lt(i, a, h, t), s = i.depth + h, e.backgroundColor && (r.style.backgroundColor = e.backgroundColor, e.borderColor && (r.style.borderColor = e.borderColor))
                }
                return n = e.backgroundColor ? $e.makeVList({
                    positionType: "individualShift",
                    children: [{
                        type: "elem",
                        elem: r,
                ...
                }, t), /cancel/.test(a) && (n.height = i.height, n.depth = i.depth), /cancel/.test(a) && !l ? $e.makeSpan(["mord", "cancel-lap"], [n], t) : $e.makeSpan(["mord"], [n], t)
            },
            gr = function(e, t) {
        ...
        function br(e) {
            ...
            for (var r = e.nextToken.text;
                "\\hline" === r || "\\hdashline" === r;) e.consume(), t.push("\\hdashline" === r), e.consumeSpaces(), r = e.nextToken.text;
            return t
        }
        ...
        var kr = function(e, t) {
                ...
                function v(e) {
                    for (var t = 0; t < e.length; ++t) 0 < t && (g += .25), l.push({
                        pos: g,
                        isDashed: e[t]
                    })
                }
                for (v(a[0]), r = 0; r < e.body.length; ++r) {
                    ...
                    var S = e.rowGaps[r],
                        z = 0;
                    S && 0 < (z = He(S, t)) && (x < (z += f) && (x = z), z = 0), e.addJot && (x += u), w.height = b, w.depth = x, g += b, w.pos = g, g += x + z, s[r] = w, v(a[r + 1])
                }
                var M, T, A = g / 2 + t.fontMetrics().axisHeight,
                    B = e.cols || [],
                    C = [];
                for (T = n = 0; n < o || T < B.length; ++n, ++T) {
                    for (var N = B[T] || {}, q = !0;
                        "separator" === N.type;) {
                        if (q || ((M = $e.makeSpan(["arraycolsep"], [])).style.width = t.fontMetrics().doubleRuleSep + "em", C.push(M)), "|" === N.separator) {
                    ...
                    if (!(o <= n)) {
                        var I = void 0;
                        (0 < n || e.hskipBeforeAndAfter) && 0 !== (I = Y.deflt(N.pregap, m)) && ((M = $e.makeSpan(["arraycolsep"], [])).style.width = I + "em", C.push(M));
                        var R = [];
                        for (r = 0; r < i; ++r) {
                            var L = s[r],
                                H = L[n];
                        ...
                        R = $e.makeVList({
                            positionType: "individualShift",
                            children: R
                        }, t), R = $e.makeSpan(["col-align-" + (N.align || "c")], [R]), C.push(R), (n < o - 1 || e.hskipBeforeAndAfter) && 0 !== (I = Y.deflt(N.postgap, m)) && ((M = $e.makeSpan(["arraycolsep"], [])).style.width = I + "em", C.push(M))
                    }
                }
                if (s = $e.makeSpan(["mtable"], C), 0 < l.length) {
                    for (var P = $e.makeLineSpan("hline", t, .05), F = $e.makeLineSpan("hdashline", t, .05), V = [{
                            type: "elem",
                            elem: s,
                            shift: 0
                        }]; 0 < l.length;) {
            ...
            Sr = function(e, t) {
                return new Mt.MathNode("mtable", e.body.map(function(e) {
                    return new Mt.MathNode("mtr", e.map(function(e) {
        ...
        yr({
            ...
            handler: function(e, t) {
                var r = {
                    cols: (Qe(t[0]) ? [t[0]] : Ze(t[0], "ordgroup").body).map(function(e) {
                        var t = function(e) {
                            var t = Qe(e);
        ...
        lt({
            ...
            handler: function(e, t) {
                ...
                for (var a = "", o = 0; o < i.body.length; ++o) a += Ze(i.body[o], "textord").text;
                if ("\\begin" !== n) return {
                    type: "environment",
                    mode: r.mode,
                    name: a,
        ...
        var Or = function(e, t) {
                ...
                n = t.havingStyle(a);
                var h, m, c, u, p, d, f, g, v, y, b = bt(e.denom, n, t);
                if (c = e.hasBarLine ? (m = (h = e.barSize ? (m = He(e.barSize, t), $e.makeLineSpan("frac-line", t, m)) : $e.makeLineSpan("frac-line", t)).height, h.height) : (h = null, m = 0, t.fontMetrics().defaultRuleThickness), d = r.size === q.DISPLAY.size ? (u = t.fontMetrics().num1, p = 0 < m ? 3 * c : 7 * c, t.fontMetrics().denom1) : (p = 0 < m ? (u = t.fontMetrics().num2, c) : (u = t.fontMetrics().num3, 3 * c), t.fontMetrics().denom2), h) {
                    ...
                    k < p && (u += .5 * (p - k), d += .5 * (p - k)), f = $e.makeVList({
                        positionType: "individualShift",
                        children: [{
                            type: "elem",
                            elem: b,
                ...
                return n = t.havingStyle(r), f.height *= n.sizeMultiplier / t.sizeMultiplier, f.depth *= n.sizeMultiplier / t.sizeMultiplier, g = r.size === q.DISPLAY.size ? t.fontMetrics().delim1 : t.fontMetrics().delim2, v = null == e.leftDelim ? yt(t, ["mopen"]) : hr(e.leftDelim, g, !0, t.havingStyle(r), e.mode, ["mopen"]), y = e.continued ? $e.makeSpan([]) : null == e.rightDelim ? yt(t, ["mclose"]) : hr(e.rightDelim, g, !0, t.havingStyle(r), e.mode, ["mclose"]), $e.makeSpan(["mord"].concat(n.sizingClasses(t)), [v, $e.makeSpan(["mfrac"], [f]), y], t)
            },
            Ir = function(e, t) {
        ...
        var Hr = function(e, t) {
            var r, n, i = t.style,
                a = Ke(e, "supsub");
            n = a ? (r = a.sup ? bt(a.sup, t.havingStyle(i.sup()), t) : bt(a.sub, t.havingStyle(i.sub()), t), Ze(a.base, "horizBrace")) : Ze(e, "horizBrace");
            var o, s = bt(n.base, t.havingBaseStyle(q.DISPLAY)),
                l = Dt(n, t);
            if (n.isOver ? (o = $e.makeVList({
                    positionType: "firstBaseline",
                    children: [{
                        type: "elem",
                        elem: s
                ...
                }, t)).children[0].children[0].children[1].classes.push("svg-align") : (o = $e.makeVList({
                    positionType: "bottom",
        ...
        lt({
            ...
            handler: function(e, t) {
                for (var r = e.parser, n = Ze(t[0], "url").url, i = [], a = 0; a < n.length; a++) {
                    var o = n[a];
            ...
            htmlBuilder: function(e, t) {
                var r;
                r = "clap" === e.alignment ? (r = $e.makeSpan([], [bt(e.body, t)]), $e.makeSpan(["inner"], [r], t)) : $e.makeSpan(["inner"], [bt(e.body, t)]);
                var n = $e.makeSpan(["fix"], []),
                    i = $e.makeSpan([e.alignment], [r, n], t),
                    a = $e.makeSpan(["strut"]);
                return a.style.height = i.height + i.depth + "em", a.style.verticalAlign = -i.depth + "em", i.children.unshift(a), i = $e.makeVList({
                    positionType: "firstBaseline",
                    children: [{
                        type: "elem",
                        elem: i
                    }]
                }, t), $e.makeSpan(["mord"], [i], t)
            },
            mathmlBuilder: function(e, t) {
        ...
        var Pr = function(e, t) {
                var r, n, i, a = !1,
                    o = Ke(e, "supsub");
                o ? (r = o.sup, n = o.sub, i = Ze(o.base, "op"), a = !0) : i = Ze(e, "op");
                var s, l = t.style,
                    h = !1;
                if (l.size === q.DISPLAY.size && i.symbol && !Y.contains(["\\smallint"], i.name) && (h = !0), i.symbol) {
                    var m = h ? "Size2-Regular" : "Size1-Regular",
                        c = "";
                    if ("\\oiint" !== i.name && "\\oiiint" !== i.name || (c = i.name.substr(1), i.name = "oiint" === c ? "\\iint" : "\\iiint"), s = $e.makeSymbol(i.name, m, "math", t, ["mop", "op-symbol", h ? "large-op" : "small-op"]), 0 < c.length) {
                        var u = s.italic,
                    ...
                    var d = dt(i.body, t, !0);
                    1 === d.length && d[0] instanceof O ? (s = d[0]).classes[0] = "mop" : s = $e.makeSpan(["mop"], $e.tryCombineChars(d), t)
                } else {
                    for (var f = [], g = 1; g < i.name.length; g++) f.push($e.mathsym(i.name[g], i.mode));
            ...
            Fr = function(e, t) {
                ...
                if (e.symbol) r = new St("mo", [Tt(e.name, e.mode)]);
                    ...
                    if (!e.body) return kt([r = new St("mi", [new zt(e.name.slice(1))]), new St("mo", [Tt("\u2061", "text")])]);
        ...
        function Gr(e, t, r) {
            for (var n = dt(e, t, !1), i = t.sizeMultiplier / r.sizeMultiplier, a = 0; a < n.length; a++) {
        ...
        lt({
            ...
            htmlBuilder: function(e, t) {
                if (0 < e.body.length) {
                    for (var r = e.body.map(function(e) {
                        ...
                        }), n = dt(r, t.withFont("mathrm"), !0), i = 0; i < n.length; i++) {
                        var a = n[i];
            ...
            mathmlBuilder: function(e, t) {
                for (var r = Ct(e.body, t.withFont("mathrm")), n = !0, i = 0; i < r.length; i++) {
                    var a = r[i];
                    if (a instanceof Mt.SpaceNode);
                    else if (a instanceof Mt.MathNode) switch (a.type) {
                        case "mi":
                        case "mn":
                        case "ms":
                        case "mspace":
                        ...
                        case "mo":
                            var o = a.children[0];
                            1 === a.children.length && o instanceof Mt.TextNode ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : n = !1;
                            break;
                        default:
                            n = !1
                    } else n = !1
        ...
        ht({
            type: "supsub",
            htmlBuilder: function(e, t) {
                var r, n, i, a = (n = t, (i = (r = e).base) ? "op" !== i.type ? "accent" === i.type ? Y.isCharacterBox(i.base) ? Pt : null : "horizBrace" !== i.type ? null : !r.sub === i.isOver ? Hr : null : i.limits && (n.style.size === q.DISPLAY.size || i.alwaysHandleSupSub) ? Pr : null : null);
                if (a) return a(e, t);
                var o, s, l, h = e.base,
                    m = e.sup,
                    c = e.sub,
                ...
                if (m) {
                    ...
                    o = bt(m, v, t), g || (d = u.height - v.fontMetrics().supDrop * v.sizeMultiplier / t.sizeMultiplier)
                }
                if (c) {
                    var y = t.havingStyle(t.style.sub());
                    s = bt(c, y, t), g || (f = u.depth + y.fontMetrics().subDrop * y.sizeMultiplier / t.sizeMultiplier)
                }
                l = t.style === q.DISPLAY ? p.sup1 : t.style.cramped ? p.sup3 : p.sup2;
                var b, x = t.sizeMultiplier,
                    w = .5 / p.ptPerEm / x + "em",
                    k = null;
                if (s) {
                ...
                if (o && s) {
                    ...
                    d = Math.max(d, l, o.depth + .25 * p.xHeight), b = $e.makeVList({
                        positionType: "shift",
                        positionData: -d,
                        children: [{
                            type: "elem",
            ...
            mathmlBuilder: function(e, t) {
                ...
                var a, o = [qt(e.base, t)];
                if (e.sub && o.push(qt(e.sub, t)), e.sup && o.push(qt(e.sup, t)), n) a = r ? "mover" : "munder";
                else if (e.sub)
                    if (e.sup) {
                        var s = e.base;
        ...
        ht({
            ...
            mathmlBuilder: function(e, t) {
                var r, n = Tt(e.text, e.mode, t),
                    i = Bt(e, t) || "normal";
                return r = "text" === e.mode ? new Mt.MathNode("mtext", [n]) : /[0-9]/.test(e.text) ? new Mt.MathNode("mn", [n]) : "\\prime" === e.text ? new Mt.MathNode("mo", [n]) : new Mt.MathNode("mi", [n]), i !== Wr[r.type] && r.setAttribute("mathvariant", i), r
            }
        });
        var jr = {
                "\\nobreak": "nobreak",
        ...
        ht({
            ...
            htmlBuilder: function(e, t) {
                if ($r.hasOwnProperty(e.text)) {
                    ...
                    if ("text" !== e.mode) return $e.makeSpan(["mspace", r], [$e.mathsym(e.text, e.mode, t)], t);
                    var n = $e.makeOrd(e, t, "textord");
                    return n.classes.push(r), n
                }
                if (jr.hasOwnProperty(e.text)) return $e.makeSpan(["mspace", jr[e.text]], [], t);
                throw new X('Unknown type of space "' + e.text + '"')
            },
            mathmlBuilder: function(e, t) {
                if ($r.hasOwnProperty(e.text)) return new Mt.MathNode("mtext", [new Mt.TextNode("\xa0")]);
            ...
            type: "tag",
            mathmlBuilder: function(e, t) {
                var r = new Mt.MathNode("mtable", [new Mt.MathNode("mlabeledtr", [new Mt.MathNode("mtd", [Nt(e.tag, t)]), new Mt.MathNode("mtd", [Nt(e.body, t)])])]);
        ...
        var Zr = {
            ...
            Qr = function(e, t) {
                var r = e.font;
                return r ? Zr[r] ? t.withTextFontFamily(Zr[r]) : Kr[r] ? t.withTextFontWeight(Kr[r]) : t.withTextFontShape(Jr[r]) : t
            };
        lt({
            type: "text",
            ...
            htmlBuilder: function(e, t) {
                for (var r = en(e), n = [], i = t.havingStyle(t.style.text()), a = 0; a < r.length; a++) {
                    var o = r[a];
                    "~" === o && (o = "\\textasciitilde"), n.push($e.makeSymbol(o, "Typewriter-Regular", e.mode, i, ["mord", "texttt"]))
                }
        ...
        }), un("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"), un("\\TextOrMath", function(e) {
        ...
        un("\\char", function(e) {
            ...
            if (t) {
                if (null == (n = pn[r.text]) || t <= n) throw new X("Invalid base-" + t + " digit " + r.text);
                for (var i; null != (i = pn[e.future().text]) && i < t;) n *= t, n += i, e.popToken()
            }
            return "\\@char{" + n + "}"
        });
        var dn = function(e, t) {
        ...
        var fn = function(e, t, r) {
            ...
            if (1 === (n = e.consumeArgs(1)[0]).length && "[" === n[0].text) {
                for (var s = "", l = e.expandNextToken();
                    "]" !== l.text && "EOF" !== l.text;) s += l.text, l = e.expandNextToken();
        ...
        var bn = {
            ...
            xn = function() {
                function e(e, t, r) {
                    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new hn(cn, t.macros), this.mode = r, this.stack = []
                }
                var t = e.prototype;
                return t.feed = function(e) {
                    ...
                    var n = 0;
                    if (-1 !== r.indexOf("#"))
                        for (var i = r.replace(/##/g, ""); - 1 !== i.indexOf("#" + (n + 1));) ++n;
                    for (var a = new ln(r), o = [], s = a.lex();
                        "EOF" !== s.text;) o.push(s), s = a.lex();
                    return o.reverse(), {
                        tokens: o,
                        numArgs: n
                    }
                }, t.isDefined = function(e) {
                    return this.macros.has(e) || tn.hasOwnProperty(e) || W.math.hasOwnProperty(e) || W.text.hasOwnProperty(e) || bn.hasOwnProperty(e)
                }, e
            }(),
            wn = {
                "\u0301": {
            ...
            Sn = function() {
                function a(e, t) {
                    this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new xn(e, t, this.mode), this.settings = t, this.leftrightDepth = 0
                }
                var e = a.prototype;
                return e.expect = function(e, t) {
                    ...
                    for (var e = this.nextToken.text, t = [], r = 0; r < e.length; r++) t.push({
                        type: "textord",
                        mode: "text",
                        text: e[r]
                    });
                    ...
                    for (;;) {
                        ...
                        if ("\\limits" === i.text || "\\nolimits" === i.text) {
                            ...
                            var s = {
                                ...
                                l = [s];
                            for (this.consume();
                                "'" === this.nextToken.text;) l.push(s), this.consume();
                    ...
                    for (var n = this.nextToken, i = n, a = "";
                        "EOF" !== this.nextToken.text && (e.test(a + this.nextToken.text) || "%" === this.nextToken.text);) "%" !== this.nextToken.text ? (a += (i = this.nextToken).text, this.consume()) : this.consumeComment();
                    ...
                    if ("string" != typeof(i = a) && (i = i.unit), !(i in Re || i in Le || "ex" === i)) throw new X("Invalid unit: '" + a.unit + "'", t);
                    return {
                        type: "size",
                        mode: this.mode,
                        value: a,
                    ...
                    if (i && this.switchMode(i), l === (t ? "[" : "{")) {
                        ...
                        var h = this.parseExpression(!1, t ? "]" : "}"),
                            m = this.nextToken;
                        return i && this.switchMode(o), this.gullet.endGroup(), this.expect(t ? "]" : "}"), {
                            type: "ordgroup",
                            mode: this.mode,
                            loc: p.range(s, m),
                            body: h
                    ...
                    if (t) a = null;
                    else if (null == (a = this.parseFunction(n, e, r) || this.parseSymbol()) && "\\" === l[0] && !bn.hasOwnProperty(l)) {
                        if (this.settings.throwOnError) throw new X("Undefined control sequence: " + l, s);
                    ...
                    kn.hasOwnProperty(t[0]) && !W[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = kn[t[0]] + t.substr(1));
                    var i, a = sn.exec(t);
        ...
        Sn.endOfExpression = ["}", "\\end", "\\right", "&"], Sn.SUPSUB_GREEDINESS = 1;
        var zn = function(e, t) {
        ...
        "undefined" != typeof document && "CSS1Compat" !== document.compatMode && ("undefined" != typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), Mn = function() {
        ...
        var Tn = function(e, t, r) {
            ...
            Bn = {
                ...
                __renderToHTMLTree: function(t, e) {
                    ...
                    try {
                        var o = zn(t, a);
                        return n = wt(o, Et(r = a)), i = $e.makeSpan(["katex"], [n]), r.displayMode ? $e.makeSpan(["katex-display"], [i]) : i
                    } catch (e) {
                        return Tn(e, t, a)
                    }
                },
